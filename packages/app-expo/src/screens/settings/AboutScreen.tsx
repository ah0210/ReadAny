      ...
      >
        ...
        <View style={styles.logoSection}>
          ...
          <Text style={styles.desc}>
            {t(
              "about.desc",
              "一个跨平台的智能电子书阅读器，支持 AI 对话、TTS 朗读、多语言翻译",
            )}
          </Text>
        </View>
          ...
          <View style={styles.linksCard}>
            {LINKS.map((link, idx) => (
              <TouchableOpacity
                ...
                style={[
                  styles.linkItem,
                  idx < LINKS.length - 1 && styles.linkItemBorder,
                ]}
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                Linking.openURL(
                  "https://github.com/nicepkg/ReadAny/issues",
                )
              }
              activeOpacity={0.7}
            >
        ...
        <Text style={styles.madeBy}>
          {t("about.madeBy", "Made with ❤️ by nicepkg")}
        </Text>
      </ScrollView>
    </SafeAreaView>
  );
